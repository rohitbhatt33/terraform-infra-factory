...
# 2. Create Public Subnets (For Load Balancers / NAT Gateways)
...
# 3. Create Private Subnets (For your future EKS Kubernetes Nodes)
...
# 4. Internet Gateway for Public Traffic
...
# # 6. NAT Gateway (Allows private subnets to securely access the internet)
